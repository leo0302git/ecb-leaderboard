window.ECB_LEADERBOARD_DATA = {
  "meta": {
    ...
    "source": "/hpc_data/jczhong/frontis-bench/outputs/report_data/merged/hard120_29combo_current",
    "notes": [
      "This dataset is materialized from outputs/report_data and contains no raw model responses or artifacts."
    ],
    "summary_source": "/hpc_data/jczhong/frontis-bench/outputs/report_data/report_inputs/hard120_29combo_current.html_data.json",
    ...
    "site_generated_at": "2026-06-21T21:50:44",
    "source_tiers": {
      "leaderboard": "paper_copied",
      "leaderboard_path": "/hpc_data/jczhong/frontis-bench/docs/nonstateful_hard120_29combo_leaderboard_scatter.summary.json",
      "task_matrix": "paper_copied",
      "task_matrix_path": "/hpc_data/jczhong/frontis-bench/docs/nonstateful_hard120_29combo_task_score_matrix_20260603.csv",
      "fig2_funnel": "paper_copied",
      "fig2_funnel_path": "/hpc_data/jczhong/FrontisBench/assets/figures/fig2_funnel/data.json",
      "fig6_artifact_type_heatmap": "paper_copied",
      "fig6_artifact_type_heatmap_path": "/hpc_data/jczhong/FrontisBench/assets/figures/fig6_artifact_type_heatmap/data.json",
      "fig7_dimension_profile_heatmap": "paper_copied",
      "fig7_dimension_profile_heatmap_path": "/hpc_data/jczhong/FrontisBench/assets/figures/fig7_dimension_profile_heatmap/data.json",
      "fig3_benchmark_statistics": "paper_copied",
      "fig3_benchmark_statistics_path": "/hpc_data/jczhong/FrontisBench/assets/figures/fig3_benchmark_statistics/data.json"
    },
    "lookup_policy": [
      ...
      "hardest": [
        {
          ...
          "subclassName": "技能安装与配置",
          "businessTask": "安装Agent技能",
          "primaryScore": 0.455,
        ...
        {
          "taskId": "fb-293915333729767424_i0177",
          "subclassName": "技术文档与代码分析",
          "businessTask": "撰写技术架构文档",
          "primaryScore": 0.536,
      ...
      "hardest": [
        {
          ...
          "subclassName": "项目推进与策划",
          "businessTask": "分析工程进度计划",
          "primaryScore": 0.227,
          "bestCombo": "deepagents/sonnet-4.6",
          "bestScore": 0.655
        },
        {
          "taskId": "fb-296965480151789568_i0008",
          "subclassName": "项目推进与策划",
          "businessTask": "设计进度预警方案",
          "primaryScore": 0.45,
        ...
        },
        {
          ...
          "subclassName": "发布计划与沟通管理",
          "businessTask": "生成工时缺填通知",
          "primaryScore": 0.466,
      ...
      "hardest": [
        {
          ...
          "subclassName": "项目立项与文档撰写",
          "businessTask": "修订计费设计文档",
          "primaryScore": 0.268,
          "bestCombo": "deepagents/sonnet-4.6",
          "bestScore": 0.648
        },
        {
          ...
          "subclassName": "PPT优化与转化",
          "businessTask": "重构PPT排版",
          "primaryScore": 0.287,
          "bestCombo": "deepagents/MiniMax-M3",
          "bestScore": 0.728
        },
        {
          ...
          "subclassName": "产品命名与架构设计",
          "businessTask": "生成品牌PPT",
          "primaryScore": 0.319,
          "bestCombo": "deepagents/sonnet-4.6",
          "bestScore": 0.622
        }
      ...
      "hardest": [
        {
          ...
          "subclassName": "文档修订与撰写",
          "businessTask": "修订活动总结文档",
          "primaryScore": 0.275,
        ...
        },
        {
          ...
          "subclassName": "周报与OKR文档管理",
          "businessTask": "细化OKR职责文档",
          "primaryScore": 0.335,
    ...
    },
    {
      ...
      "hardest": [
        ...
        },
        {
          ...
          "subclassName": "财务与数据分析",
          "businessTask": "统计港口历史数据",
          "primaryScore": 0.305,
          "bestCombo": "openclaw/MiniMax-M3",
          "bestScore": 0.535
        },
        {
          "taskId": "fb-305942243078873088_i0003",
          "subclassName": "经营数据分析",
          "businessTask": "分析APP数据",
          "primaryScore": 0.321,
          "bestCombo": "deepagents/gpt-5.5",
          "bestScore": 0.728
        }
    ...
    },
    {
      ...
      "hardest": [
        ...
        },
        {
          ...
          "subclassName": "业务分析与评估",
          "businessTask": "解析平台技术方案",
          "primaryScore": 0.317,
          "bestCombo": "deepagents/gpt-5.5",
          "bestScore": 0.565
        }
  ...
  "taskExtremes": {
    ...
    "highestVariance": [
      ...
      },
      {
        ...
        "classId": "data_business_analysis",
        "classLabel": "Data & Business Analysis",
        "subclassName": "数据整理与校验",
        "businessTask": "补充工序采集表",
        "primaryScore": 0.639,
        "validScore": 0.663,
        "scoreStd": 0.361,
        "failedN": 2,
  ...
  "cases": [
    ...
    },
    {
      ...
      "image": "assets/cases/fb-296965480151789568_i0013__claudecode__opus-4.6__tonglian-tasks-summary__sheet_01__playwright.png"
    },
    {
      "key": "skill-standards",
    ...
    },
    {
      ...
      "image": "assets/cases/fb-300327546568937472_i0008__hermes__haiku-4.5__frontis-brand-positioning_html_playwright_fullpage.png"
    }
  ],
  "derivedBoards": {
    "efficiency": [
